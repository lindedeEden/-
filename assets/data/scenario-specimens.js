  ...
  scenarios: [
    {
      ...
      taskCardLegacy:
        '目前工作清單上共有 10 筆檢體。在開始編輯前，您想知道哪些檢體仍需推片／拉片確認，以免白做工。可從選單「LIS 查詢」跨系統查閱註記，或從檢體清單與側欄資訊判斷。請找出所有相關檢體編號，並簡要說明您的判斷依據。'
    },
    {
      id: 'scenario-2',
      ...
      taskCardLegacy:
        '請在檢體清單中完成以下任務（必要時可從選單「LIS 查詢」查閱註記、檢體歸位、操作機台與歷史報告）：\n\n' +
        '（一）找出 3 筆「需拉片確認」檢體，說明您如何得知各筆採血管的歸位位置。\n\n' +
        '（二）找出 2 筆「血小板確認」待辦，說明各筆玻片所在的機台。'
    },
    {
      id: 'scenario-3',
      ...
      taskCardLegacy:
        '清單中有三筆檢體需參考病患歷史報告：\n' +
        'H5080706286、H5080720647、H5080721401\n\n' +
        '可從選單「LIS 查詢」查閱歷史報告，或進入各筆檢體閱片畫面查看檢體單資料，並口頭說明歷史報告與本次結果的關聯。'
    },
    {
      id: 'scenario-4',
